...
import {crearPromocion, editarPromocion} from "../../services/promocionService";
...
export function FormularioPromocion({onClose, promocionAEditar}: {
    onClose: () => void;
    ...
    const areDetallesEqual = (a: PromocionDetalle[] = [], b: PromocionDetalle[] = []) => {
    ...
    const noSeRealizaronCambios = (): boolean => {
        ...
        const sinCambiosDetalle = areDetallesEqual(promocionAEditar.detalle || [], detalle || []);
